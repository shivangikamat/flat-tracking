        ...
        <section className="listings">
          <div className="section-heading">
            ...
            <div className="sort-controls" aria-label="Sort listings">
              <Link className={!sort ? "active" : ""} href="/listings">
                Newest
              </Link>
              <Link className={sort === "postcode" ? "active" : ""} href="/listings?sort=postcode">
                Postcode
              </Link>
              <Link className={sort === "distance" ? "active" : ""} href="/listings?sort=distance">
                Appleton distance
              </Link>
              <Link className={sort === "rent-asc" ? "active" : ""} href="/listings?sort=rent-asc">
                Rent low-high
              </Link>
              <Link className={sort === "rent-desc" ? "active" : ""} href="/listings?sort=rent-desc">
                Rent high-low
              </Link>
            </div>
          </div>
